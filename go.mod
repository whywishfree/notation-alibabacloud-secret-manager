...
replace github.com/AliyunContainerService/ack-ram-tool/pkg/credentials/provider v0.0.0 => github.com/AliyunContainerService/ack-ram-tool/pkg/credentials/provider v0.10.0
